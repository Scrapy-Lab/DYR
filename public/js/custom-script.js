$(window).on("scroll", function () {
    if ($(window).scrollTop() > 3666) {
        $('#contactLink').addClass('current');
        $('#home').removeClass('current');
        $('#aboutUs').removeClass('current');
        $('#categoriesTab').removeClass('current');
        //   console.log($(window).scrollTop());
    }
    else if ($(window).scrollTop() < 2648 && $(window).scrollTop() > 1753) {
    ...
    } else if ($(window).scrollTop() < 3665 && $(window).scrollTop() > 2648) {

        $('#categoriesTab').addClass('current');
        $('#aboutUs').removeClass('current');
        $('#home').removeClass('current');
        $('#contactLink').removeClass('current');
...
(function ($) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const contactPartScrollTop = 3666; // Your desired scrolltop value

        contactLink[0].addEventListener("click", function (event) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const contactLink = document.getElementById("aboutUs");


        const contactPartScrollTop = 1753; // Your desired scrolltop value
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const contactLink = document.getElementById("categoriesTab");


        const contactPartScrollTop = 2648; // Your desired scrolltop value
